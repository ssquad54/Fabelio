 ...
 */
//
// nama: Gill - SO Terbilang CS
// id: _gill_so_terbilang_cs
...
define(['N/record', 'N/error'], function(record, error) {
    ...
    function pageInit(context) {
        ...
        rec.setValue({
            fieldId: 'custbody_ksi_terbilang',
            value: '...',
    ...
    function fieldChanged(context) {
        ...
        if (context.fieldId === 'custbody_ksi_terbilang' || context.fieldId === 'total') {
            log.debug({
                "title": "check: record",
                "details": rec
            });
            ...
            sayit = terbilang(amt, 'POINT', "RUPIAH");
            log.debug({
            ...
            rec.setValue({
                fieldId: 'custbody_ksi_terbilang',
                value: sayit.replace(/\s\s+/g, ' ').trim(),
                ignoreFieldChange: true
            });
        }
