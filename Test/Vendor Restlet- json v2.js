                ...
                if (vendorList.length > 0) {
                    for (var i = 0; i < vendorList.length; i++) {
                        ...
                        for (var j = 0; j < addrCount; j++) {
                            var subAddr = recLoad.getSublistSubrecord({
                                sublistId: 'addressbook',
                            ...
                            addressList.push({
                                label: recLoad.getSublistValue('addressbook', 'label', j),
                                defaultshipping: recLoad.getSublistValue('addressbook', 'defaultshipping', j),
                                defaultbilling: recLoad.getSublistValue('addressbook', 'defaultbilling', j),
                                attention: subAddr.getValue('attention'),
                                addressee: subAddr.getValue('addressee'),
                                addrtext: subAddr.getValue('addrtext'),
                                addr1: subAddr.getValue('addr1'),
                                addr2: subAddr.getValue('addr2'),
                                addrphone: subAddr.getValue('addrphone'),
                                city: subAddr.getText('city'),
                                state: subAddr.getValue('state'),
                                zip: subAddr.getValue('zip'),
                            });
                        ...
                        recStr.push({
                            ...
                            vendorid: recLoad.getValue('entityid'),
                            legalname: recLoad.getValue('legalname'),
                            isperson: recLoad.getValue('isperson'),
                            companyname: recLoad.getValue('companyname'),
                            firstname: recLoad.getValue('firstname'),
                            middlename: recLoad.getValue('middlename'),
                            lastname: recLoad.getValue('lastname'),
                            klasifikasiVendor: recLoad.getText('custentity_ksi_klasifikasi_vendor'),
                            subsidiary: recLoad.getText('subsidiary'),
                            nppkp: recLoad.getValue('custentity_ksi_nppkp'),
                            noNpwp: recLoad.getValue('vatregnumber'),
                            noKtp: recLoad.getValue('custentity_ksi_ktp'),
                            email: recLoad.getValue('email'),
                            phone: recLoad.getValue('phone'),
                            terms: recLoad.getText('terms'),
                            namaBank: recLoad.getText('custentity_ksi_nama_bank'),
                            noRekening: recLoad.getValue('accountnumber'),
                            payablesaccount: recLoad.getText('payablesaccount'),
                            isinactive: recLoad.getValue('isinactive'),
