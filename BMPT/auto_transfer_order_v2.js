...
define(['N/record', 'N/search', 'N/transaction'], function(record, search, transaction) {
    function beforeSubmit(context) {
        ...
        for (var u = 0; u < lineCount; u++) {
            ...
            if (createTO == true) {
                // check item sublist has sublist subrecord
                ...
                // iff true - remove sublist subrecord and set warehouse to mainline warehouse 
                if (hasSublist) {
                    ...
                    log.debug('remove subrecord', 'Done !!');

                    //recheck to make sure the sublistsublist sub record is removed
